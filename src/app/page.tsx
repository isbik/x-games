...
export default function Games() {
  return (
    <div className="flex items-center justify-center p-6 container bg-gradient-to-br from-yellow-300 via-pink-300 to-purple-300 min-h-screen">
      <div className="flex flex-col space-y-6 max-w-lg w-full">
        {games.map((game) => (
          <Link key={game.id} href={game.url} className="group">
            <Card className="transition-transform transform group-hover:scale-105 shadow-lg rounded-2xl bg-white border-4 border-pink-400">
